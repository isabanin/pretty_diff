...
Wrap it with HTML, add the CSS file that you can find below and you will get something like this:
...
By default PrettyDiff will generate HTML that can be easily colored with the CSS that you can find here: http://logintocss
